      ...
      <div class="sidebar">
          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                  ...
                  <li class="nav-header text-info"><i class="fas fa-user-shield mr-2"></i><strong>MENU ADMIN</strong>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                      <a wire:navigate href="{{ route('admin.jasabubut.index') }}" class="nav-link @yield('menuAdminJasaBubut')">
                  ...
                  <li class="nav-item">
                      <a wire:navigate href="{{ route('admin.sparepart.index') }}" class="nav-link @yield('menuAdminSparepart')">
                  ...
                  <li class="nav-item">
                      <a wire:navigate href="{{ route('pelanggan.order.index') }}" class="nav-link @yield('menuPelangganOrder')">
