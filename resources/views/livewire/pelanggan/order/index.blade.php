                ...
                <div class="card-body"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card shadow-lg border-0">
                                            <div class="card-body text-center">
                                                ...
                                                <h5 class="mb-1"><b>{{ $sp->nama_sparepart }}</b></h5>
                                                <b class="text-muted d-block mb-1">{{ $sp->merek }}</b>
                                                <p class="text-success mb-2">
                                                    <b>Rp.{{ number_format((float) $sp->harga, 0, ',', '.') }}</b>
                                                </p>
                    ...
                    @if ($step == 3)
                        ...
                        <div class="card p-4 shadow-sm border-0">
                            <h4 class="text-info"><b>Konfirmasi Pesanan</b></h4>
                            @if ($jenis_transaksi == 'sparepart')
                            ...
                            @if ($item)
                                <div class="mb-3 text-center">
                                    ...
                                    @endif
                                    <h5 class="mb-1"><b>{{ $item->nama_sparepart ?? $item->nama_jasa }}</b></h5>
                                    @if ($jenis_transaksi == 'sparepart')
                                        <b class="text-muted mb-1 d-block">Merek : {{ $item->merek }}</b>
                                    @endif
                                    <p><b>Harga Satuan : Rp. {{ number_format((float) $item->harga, 0, ',', '.') }}</b>
                                    </p>
                                </div>
                            @endif
                            ...
                            <h5 class="mt-3">
                                Total:
                                <b class="text-success">Rp.{{ number_format((float) $total_harga, 0, ',', '.') }}</b>
                            </h5>
